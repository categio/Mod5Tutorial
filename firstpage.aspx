<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="firstpage.aspx.cs" Inherits="Lecture5Tutorial.firstpage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="width: 100%; background-image: url('App_Data/images/triangles.png'); background-repeat: no-repeat; background-attachment: scroll;">
            <tr>
                <td class="auto-style2" style="background-image: url('App_Data/images/bkground.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-position: right bottom; font-family: 'Eras Demi ITC'; font-size: large; font-weight: normal; font-style: normal; font-variant: normal; color: #FFFF00;">
            ...
            <tr>
                <td class="auto-style3" style="background-image: url('App_Data/images/bkground.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-position: right bottom; font-family: 'Eras Demi ITC'; font-size: large; font-weight: normal; font-style: normal; font-variant: normal; color: #FFFF00;">
            ...
            <tr>
                ...
                <td class="auto-style2" style="background-image: url('App_Data/images/bkground.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-position: right bottom; font-family: 'Eras Demi ITC'; font-size: large; font-weight: normal; font-style: normal; font-variant: normal; color: #FFFF00;">
                    <asp:DropDownList ID="stateDropDownList" runat="server" Height="25px" Width="208px">
